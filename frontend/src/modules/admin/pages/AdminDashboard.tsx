...
const StatCard = ({
  ...
  <Paper
    sx={{ p: 3, borderRadius: 3, border: "1px solid #E8ECF0", height: "100%" }}
  >
    <Box
      sx={{
        display: "flex",
    ...
    >
      <Box>
        ...
        <Typography
          sx={{ fontFamily: "Sora", fontWeight: 800, fontSize: 28, color }}
        >
          {value}
        </Typography>
        {subtitle && (
        ...
        {trend && (
          ...
          >
            ...
            <Typography
              sx={{ fontSize: 12, color: "#2E7D32", fontWeight: 600 }}
            >
              {trend}
            </Typography>
          </Box>
...
const AdminDashboard = () => {
  ...
  return (
    <Box>
      {/* Header */}
      <Box sx={{ mb: 4 }}>
        <Typography variant="h4" sx={{ fontFamily: "Sora", fontWeight: 800 }}>
          Dashboard
        </Typography>
        <Typography color="text.secondary" sx={{ mt: 0.5 }}>
          Welcome back! Here's what's happening at Swami Medical.
        </Typography>
      </Box>
        ...
        <Grid item xs={12} md={5}>
          <Paper sx={{ borderRadius: 3, border: "1px solid #E8ECF0" }}>
            ...
            >
              ...
              <Button component={Link} to="/admin/prescriptions" size="small">
                View All
              </Button>
            </Box>
            {(pendingPrescriptions?.prescriptions || []).length === 0 ? (
              ...
              ((pendingPrescriptions?.prescriptions || []) as any[])
                .slice(0, 5)
                .map((p: any) => (
                  <Box
                    key={p._id}
